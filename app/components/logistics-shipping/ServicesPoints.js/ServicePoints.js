  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-screen-lg mx-auto text-center">
        <h2 className="text-4xl font-extrabold text-gray-900 mb-8">Our Logistics and Shipping Services</h2>
        <p className="text-lg text-gray-600 mb-16">
          At Starline General Trading LLC, we provide a comprehensive range of logistics and shipping services to ensure your business runs smoothly and efficiently.
        </p>
      </div>
      <ul className="space-y-6 text-left text-gray-800">
        ...
        <li className="text-xl font-semibold mb-2 flex items-center">
          <FaArrowRight className="text-blue-500 mr-2" />
          <span className="font-semibold">
            Logistics & Fulfillment: Comprehensive services covering every aspect from warehousing to delivery.
          </span>
        </li>
        <li className="text-xl font-semibold mb-2 flex items-center">
          <FaArrowRight className="text-blue-500 mr-2" />
