        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            <svg
              ...
              fill="currentColor"
              className="w-12 h-12 bg-gray-100 p-3 rounded-md shrink-0"
              viewBox="0 0 32 32"
            >
              <path
            ...
            <div>
              ...
              Tailor our offerings to suit your specific needs.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                We prioritize the security of your goods with the latest measures.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                We ensure that everything we handle operates at peak efficiency.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                 We have a proven track record of delivering results and exceeding expectations.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                We ensure you are always informed and in the loop, enhancing collaboration and trust.
              </p>
            </div>
          </div>
        </div>
